...
#     ImageIO.write(image, "png", outputFile)
    ...
    filename1 = '../../data/results/test.png'

    filename2 = '../../data/results/test/test2.png'
#    os.makedirs(os.path.dirname(filename), exist_ok=True)

    saveImg(filename1, im_fg.astype(np.uint8))
    saveImg(filename2, im_fg.astype(np.uint8))

#     imageio.imwrite(filename, im_fg)
#
#
#     os.makedirs(os.path.dirname(filename), exist_ok=True)
#
#     imageio.imwrite(filename1, im_fg)
