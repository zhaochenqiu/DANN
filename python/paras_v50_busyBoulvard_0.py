...
#    ft_gt_it = 'png'
    ...
    net_pa = '../../data/network_busyBoulvard_v50_0/'
    sa_pa =  '../../data/fgimgs_busyBoulvard_v50_0/'

    it_pa = '../../data/fgimgs_busyBoulvard_fg2bay_v50_0/'
...
#    curidx = [710, 720, 740, 849, 1115, 1130, 1149]
    curidx    = [818, 860, 872, 1130, 1500, 1574, 1600, 1674, 1744, 1406]
