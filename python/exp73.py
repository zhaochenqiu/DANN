...
#    getListNormalData(imgs, labs, curidx, "test")
...
# #    starttime = time.time()
#     hist_data1, hist_labs1 = getNormalData(imgs, labs, 1140)
#     hist_data2, hist_labs2 = getNormalData(imgs, labs, 732 )
#     hist_data3, hist_labs3 = getNormalData(imgs, labs, 1124)
#
#
#
#
#     hist_data = torch.cat((hist_data1, hist_data2, hist_data3), dim = 0)
#     hist_labs = torch.cat((hist_labs1, hist_labs2, hist_labs3), dim = 0)
#
#     LEN_NUM = torch.numel(hist_labs)
#
#     idx = torch.randperm(LEN_NUM)
#
#
#     print("start randomize data")
#     hist_data = hist_data[idx]
#     hist_labs = hist_labs[idx]
#     print("randomize data completed")
...
#     starttime = time.time()
#     hist_data_old, hist_labs_old = getNormalData_old(imgs, labs, curidx)
#     endtime = time.time()
#
#     print("total time:", endtime - starttime)
#
...
#     print(hist_labs.shape)
#
#
#     print(hist_data_old.shape)
#     print(hist_labs_old.shape)
#
#
#
#
#     print(torch.sum(torch.abs(hist_data - hist_data_old)))
#     print(torch.sum(torch.abs(hist_labs - hist_labs_old)))
#
#     print("borderline ---------------------------")
#
