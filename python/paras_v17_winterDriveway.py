...
def main():
    ...
    pa_im = '/home/cqzhao/dataset/dataset2014/dataset/intermittentObjectMotion/winterDriveway/input'
    ft_im = 'jpg'

#    pa_gt = '/home/cqzhao/dataset/dataset2014/dataset/dynamicBackground/fountain01/groundtruth'
    pa_gt = '/home/cqzhao/dataset/dataset2014/dataset/intermittentObjectMotion/winterDriveway/groundtruth'
    ft_gt = 'png'

#     net_pa = '../../data/'
#     sa_pa = '../../data/results/'
    net_pa = '../../data/network_winterDriveway_v17/'
    sa_pa =  '../../data/fgimgs_winterDriveway_v17/'
...
#    curidx = [720, 740, 849, 1130, 1149]
#    curidx = [650, 1955, 1873, 1465, 1999]
    curidx = [600, 780, 1000, 1052, 1200, 1500, 1700, 1802, 2000, 2424, 2500]
#    curidx = [1052, 1802, 2000, 2424, 2500]
