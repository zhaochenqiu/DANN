...
#    ft_gt_it = 'png'
    ...
    net_pa = '../../data/network_winterDriveway_v50_1/'
    sa_pa =  '../../data/fgimgs_winterDriveway_v50_1/'

    it_pa = '../../data/fgimgs_winterDriveway_fg2bay_v50_1/'
...
#    curidx = [710, 720, 740, 849, 1115, 1130, 1149]
    curidx    = [1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2500]
