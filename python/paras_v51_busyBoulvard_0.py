...
#         print(i)
    ...
    pa_im = '/home/cqzhao/dataset/dataset2014/dataset/nightVideos/busyBoulvard/input'
#    pa_im = 'D:/dataset/dataset2014/dataset/dynamicBackground/fountain01/input'
    ft_im = 'jpg'

    pa_gt = '/home/cqzhao/dataset/dataset2014/dataset/nightVideos/busyBoulvard/groundtruth'
#    pa_gt = 'D:/dataset/dataset2014/dataset/dynamicBackground/fountain01/groundtruth'
    ft_gt = 'png'
...
#    ft_gt_it = 'png'
    ...
    net_pa = '../../data/network_busyBoulvard_v51_0/'
    sa_pa =  '../../data/fgimgs_busyBoulvard_v51_0/'

    it_pa = '../../data/fgimgs_busyBoulvard_fg2bay_v51_0/'
...
#    curidx = [710, 720, 740, 849, 1115, 1130, 1149]
    curidx    = [748, 763, 818, 845, 860, 872, 1130, 1500, 1574, 1600, 1674, 1744, 1184, 1406]
...
#        labs_tru = readImg_byFilesIdx(frame_idx, pa_gt, ft_gt)
        ...
        idx = ((gt_fg != 0).all() and (gt_fg != 255).all())
        im_fg[idx] = 0
