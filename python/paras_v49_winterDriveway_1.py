...
#    ft_gt_it = 'png'
    ...
    net_pa = '../../data/network_winterDriveway_v49_1/'
    sa_pa =  '../../data/fgimgs_winterDriveway_v49_1/'

    it_pa = '../../data/fgimgs_winterDriveway_fg2bay_v49_1/'
...
#    curidx = [710, 720, 740, 849, 1115, 1130, 1149]
    curidx    = [1050, 1200, 1400, 1800, 2000, 2500]
