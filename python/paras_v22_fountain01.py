...
def getSpatialData_byHistVid(vid_hist, imgs, labs, curidx, left = -1, right = 1, delta = 0.01):
    ...
    spatial_hist = spatial_hist.reshape(row_im*column_im, len_hist, byte_im*5)

    print("spatial_hist.reshape:", spatial_hist.shape)
...
#    curidx = [1140]
    ...
    data_hist, labs_hist = getSpatialData_byHistVid(vid_hist, imgs, labs, curidx[-1], -1, 1, 0.01)

    print(data_hist.shape)
    print(labs_hist.shape)
