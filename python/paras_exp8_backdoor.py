...
class ClassifyNetwork(nn.Module):
    def __init__(self, dis_num):
        ...
        self.conv1 = nn.Conv2d(3, 30, (dis_num, 1) )
        self.conv2 = nn.Conv2d(30, 500, (1, 201))
...
def main():
    ...
    pa_im = '/home/cqzhao/dataset/dataset2014/dataset/dynamicBackground/fountain01/input'
    pa_im = '/home/cqzhao/dataset/dataset2014/dataset/shadow/backdoor/input'
#    pa_im = 'D:/dataset/dataset2014/dataset/dynamicBackground/fountain01/input'
    ft_im = 'jpg'

    pa_gt = '/home/cqzhao/dataset/dataset2014/dataset/dynamicBackground/fountain01/groundtruth'
    pa_gt = '/home/cqzhao/dataset/dataset2014/dataset/shadow/backdoor/groundtruth'
#    pa_gt = 'D:/dataset/dataset2014/dataset/dynamicBackground/fountain01/groundtruth'
    ft_gt = 'png'

    net_pa = '../../data/network_backdoor/'
    sa_pa =  '../../data/fgimgs_backdoor/'
...
#    curidx = [710, 720, 740, 1130, 1149]
    curidx = [1840, 1955, 1873, 1465, 1999]
#    curidx = [1140]

    print("generating trainning data")
    data_vid, labs_vid = getListNormalData_plus(imgs, labs, curidx, "train", left_data, right_data, delta)
    print("completed")
...
#     optim_W_B = getTensorOptim(f_W_B, 0.01)
    ...
    for frame_idx in curidx:
        ...
        data_vid, labs_vid = getNormalData_plus(imgs, labs, frame_idx, left, right, delta)
    ...
    #        gt_fg = np.round(labs[curidx].detach().squeeze().numpy())
        ...
        im_fg = np.round(np.reshape(re_labs, (240, 320))*255)
