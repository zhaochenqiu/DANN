...
#     print("borderline ------------------------------")
    ...
    for epoch in range(cnt + 1, num_epoch):
        ...
        for i in range(value):
            ...
            f_Z_B = torch.cat( [prodis_mul(c_data, data[:, :, b], c_B, f_B[:, :, b], c_Z, delta, params)[1].unsqueeze(-1) for b in range(f_B.shape[-1])], dim = 3 )
...
#
#
#             c_Z_R, f_Z_B_R = difdis_mul(c_data, data[:, :, 0], c_B, f_B_R, c_Z, delta, params)
#             c_Z_G, f_Z_B_G = difdis_mul(c_data, data[:, :, 1], c_B, f_B_G, c_Z, delta, params)
#             c_Z_B, f_Z_B_B = difdis_mul(c_data, data[:, :, 2], c_B, f_B_B, c_Z, delta, params)
#
#
#
#
...
#             c_Z_B, f_Z_W_B = prodis_mul(c_data, data[:, :, 2], c_W, f_W_B, c_Z, delta, params)
#             endtime = time.time()
#             print("prodis_mul time:", endtime - starttime)
#             sum_prodis_time += endtime - starttime
#
#             starttime = time.time()
#             c_Z_R, f_Z_B_R = difdis_mul(c_data, data[:, :, 0], c_B, f_B_R, c_Z, delta, params)
#             c_Z_G, f_Z_B_G = difdis_mul(c_data, data[:, :, 1], c_B, f_B_G, c_Z, delta, params)
#             c_Z_B, f_Z_B_B = difdis_mul(c_data, data[:, :, 2], c_B, f_B_B, c_Z, delta, params)
#             endtime = time.time()
#             print("difdis_mul time:", endtime - starttime)
#             sum_difdis_time += endtime - starttime
#
#
#
#
...
#             re_labs[left:right] = output.argmax(dim = 1, keepdim = True).cpu().detach().squeeze()
#             endtime = time.time()
#             print("re_labs time:", endtime - starttime)
#             sum_relabs_time += endtime - starttime
#
#     #        print( i, ":", value )
#
#
...
#     print("")
#     print("borderline ----------------------------------------")
#     print("sum_prodis_time:", sum_prodis_time)
#     print("sum_difdis_time:", sum_difdis_time)
#     print("sum_relabs_time:", sum_relabs_time)
#     print("borderline ----------------------------------------")
#     print("")
#     print("")
#
...
#     net_pa = '../../data/'
#     sa_pa = '../../data/results/'
    net_pa = '../../data/network_fountain01_v26/'
    sa_pa =  '../../data/fgimgs_fountain01_v26/'
...
#     network, f_W_R, f_W_G, f_W_B, f_B_R, f_B_G, f_B_B = train(data_vid, labs_vid, batchsize, device, network, loss_func, prodis_mul, difdis_mul,
#           c_data, c_W, f_W_R, f_W_G, f_W_B, c_B, f_B_R, f_B_G, f_B_B, c_Z, delta, params,
#           optim_W_R, optim_W_G, optim_W_B, optim_B_R, optim_B_G, optim_B_B,
#           optim_net, net_pa, num_epoch)
