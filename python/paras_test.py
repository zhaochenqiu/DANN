...
#     gpuid = int(argv[4])
    ...
    name_categroy = 'dynamicBackground'
    name_video = 'fountain01'
    name_id = 'v_int'
...
#    curidx    = [710, 720, 740, 1130, 1149, 1184]
    curidx = [1149, 720, 693, 760, 1126, 740, 713, 870, 1027, 1184]
...
#    print(torch.sum(torch.abs(vid_hist - vid_hist_pad)))
    ...
    data_vid1,    labs_vid1    = getListNormalData_byHistVid(vid_hist, imgs, pa_gt, ft_gt,  curidx,    "train", left_data, right_data, delta)
    print("completed")

    labs_vid1    = torch.round(labs_vid1/255)
...
#    curidx    = [710, 720, 740, 1130, 1149, 1184]
#    curidx = [1149, 720, 693, 760, 1126, 740, 713, 870, 1027, 1184]
    curidx = [743, 1232, 1256, 719, 1264, 673, 899, 1099, 1299, 1499]
...
#    print(torch.sum(torch.abs(vid_hist - vid_hist_pad)))
    ...
    print("generating trainning data")
    data_vid2,    labs_vid2    = getListNormalData_byHistVid(vid_hist, imgs, pa_gt, ft_gt,  curidx,    "train", left_data, right_data, delta)
    print("completed")

    labs_vid2    = torch.round(labs_vid2/255)



    data_vid = torch.cat((data_vid1, data_vid2), dim = 0)
    labs_vid = torch.cat((labs_vid1, labs_vid2), dim = 0)
