...
class ClassifyNetwork(nn.Module):
    def __init__(self, dis_num):
        ...
        self.conv2 = nn.Conv2d(20, 10000, (1, 201))
...
#     net_pa = '../../data/'
#     sa_pa = '../../data/results/'
    net_pa = '../../data/network_fountain01_v23/'
    sa_pa =  '../../data/fgimgs_fountain01_v23/'
...
#    print(torch.sum(torch.abs(vid_hist - vid_hist_pad)))
    ...
    print("generating spatialdata")
    starttime = time.time()
    data_vid, labs_vid = getSpatialData_byHistVid(vid_hist, imgs, labs, curidx[-1], -1, 1, 0.01)
    endtime = time.time()
    print("completed total time:", endtime - starttime)
