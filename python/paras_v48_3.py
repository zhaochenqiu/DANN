...
#    pa_gt = 'D:/dataset/dataset2014/dataset/dynamicBackground/fountain01/groundtruth'
    ...
    net_pa = '../../data/network_fountain01_v48/'
    sa_pa =  '../../data/fgimgs_fountain01_v48/'
...
#    curidx = [710, 720, 740, 849, 1115, 1130, 1149]
    ...
    curidx_it = [705, 725, 730, 735, 1135, 1140, 1155, 1104, 1122, 660, 500, 670, 733, 745]
...
#    print(torch.sum(torch.abs(vid_hist - vid_hist_pad)))
    ...
    data_vid_it, labs_vid_it = getListNormalData_byHistVid(vid_hist, imgs, labs_it, curidx_it, "train", left_data, right_data, delta)
    print("completed")

    labs_vid    = torch.round(labs_vid/255)
    labs_vid_it = torch.round(labs_vid_it/255)
...
#
    ...
    data_vid = torch.cat((data_vid, data_vid_it), dim = 0)
    labs_vid = torch.cat((labs_vid, labs_vid_it), dim = 0)
...
#        labs_tru = readImg_byFilesIdx(frame_idx, pa_gt, ft_gt)
    ...
    it_pa = '../../data/fgimgs_fountain01_fg2bay_v48_3/'
