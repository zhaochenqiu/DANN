...
class ClassifyNetwork(nn.Module):
    def __init__(self, dis_num):
        ...
        self.conv2 = nn.Conv2d(20, 2000, (1, 511))
...
#    labs_vid = torch.load("../../data/labs_fountain01.pt")
    ...
    data_vid, labs_vid = getHistData(pa_im, ft_im, pa_gt, ft_gt, curidx)
...
#
    ...
    network.load_state_dict(torch.load('../../data/tempq/network_dis_0100.pt'))



    f_W_R = torch.load('../../data/tempq/layer_dis_R_0100.pt')
    f_W_G = torch.load('../../data/tempq/layer_dis_G_0100.pt')
    f_W_B = torch.load('../../data/tempq/layer_dis_B_0100.pt')
