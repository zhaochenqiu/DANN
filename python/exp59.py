...
#        print("loss = ", loss.item())
    ...
    torch.save(f_W, "f_W.pt")
    torch.save(classnet.state_dict(), "network.pt")


    f_W_load = torch.load("f_W.pt")
    classnet_load = ClassNet(LEN_Z*num_dis,2000).to(device)
    classnet_load.load_state_dict(torch.load('./network.pt'))
