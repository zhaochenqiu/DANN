...
#     print("borderline ------------------------------")
    ...
    if cnt > num_epoch:
        print("epoch is smaller than cnt")
        cnt = num_epoch - 1
...
#     net_pa = '../../data/'
#     sa_pa = '../../data/results/'
    net_pa = '../../data/network_fountain01_v39/'
    sa_pa =  '../../data/fgimgs_fountain01_v40/'
...
#    print(torch.sum(torch.abs(vid_hist - vid_hist_pad)))
    ...
    for frame_idx in range(frames):
        ...
        print("check_filename:", check_filename)
        print("frame_idx = ", frame_idx)
...
#        labs_tru = readImg_byFilesIdx(frame_idx, pa_gt, ft_gt)
        ...
        if judge_flag == 0:
            ...
            if os.path.exists(check_filename):
                ...
                print("file exist, check_filename = ", check_filename)
