...
#
#                 idx_nonzero = c_X != 0
#                 w = torch.round( z.div(c_X[idx_nonzero]) ).mul(1/border)
#
#
#
#
#                 idx_zero = c_X == 0
#
#                 print(torch.sum(idx_zero))
#                 print(torch.sum(idx_nonzero))
#
#
#             print(f_Z)
#             print(c_Z)
...
#             border_X = c_X[1] - c_X[0]
#             border_W = c_W[1] - c_W[0]
#
#             border = torch.min(border_X, border_W)
#             border = torch.tensor(0.1)
#
#
#             left = torch.min(c_X)
#             left = torch.min(left, torch.min(c_W)*torch.min(c_X))
...
def main():
    ...
    f_Z_pre, temp = prodis_net(c_X, f_X, c_W, f_W, border)
