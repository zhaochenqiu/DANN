...
#         print("border = ", border)
#
#         print("c_grad_output:", c_grad_output)
#         print("f_grad_output:", f_grad_output)
#
#
#         print("c_Z:", c_Z)
#         print("c_W:", c_W)
...
#
        ...
        return f_grad_output, f_grad_output, None, None, None, None, None, None
...
def main():
    ...
    with torch.no_grad():
        ...
        X = torch.empty(num).normal_(mean = 0, std = 2)
        W = torch.empty(num).normal_(mean = 0, std = 2)
        ...
        starttime = time.time()
        c_Z, f_Z = prodis_lay(c_X, f_X, c_W, f_W, c_Z, f_Z, border, params)
        endtime = time.time()
    ...
    c_T, f_T = getEmptyCF(-10, 10, border)

    f_T = f_T + 1
    f_T = f_T/torch.sum(f_T)
    ...
    c_Z, f_Z = prodis_lay(c_X, f_X, c_T, f_T, c_Z, f_Z, border, params)


    print("f_gt.shape:", f_gt.shape)

    loss = (f_Z - f_gt).pow(2).sum()
